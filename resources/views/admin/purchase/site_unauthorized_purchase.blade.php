        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                <div class="page-header-title">
                    <h5 class="m-b-10">{{ $currentSite->site_name }} - Unauthorized Purchases</h5>
                </div>
                <ul class="breadcrumb">
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <!-- Filters -->
                <form action="{{ url()->current() }}" method="GET" class="row mb-4" id="filterForm">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-2 d-flex gap-2">
                            ...
                            <a href="{{ url()->current() }}" class="btn btn-light border px-2 d-flex align-items-center justify-content-center" title="Clear Filters">
                                <i class="ti ti-x"></i>
                            </a>
                        </div>
                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const actionMethod = document.getElementById('actionMethod');
        ...
        document.querySelectorAll('.btn-approve').forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                Swal.fire({
                    ...
                    text: "You are about to approve this unauthorized purchase.",
                    icon: 'question',
        ...
        function loadUsers(role, preselectId = null) {
            ...
            // Note: Users API route from petty cash can be reused since it gets users for a site by role
            $.ajax({
                url: '{{ url("coordinator/pettycash/site/".$currentSite->id."/users-by-role") }}',
                type: 'GET',
                data: { role: role },
