...
@section('title', 'Repairing Machinery')
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5>All Machinery Assets Under Repair</h5>
            </div>
            <div class="card-body">
                <!-- Filters Section -->
                <form action="{{ route(getRoutePrefix() . 'machinery.repair') }}" method="GET" class="row mb-4">
                    ...
                    <div class="col-md-3 mb-2 d-flex gap-2">
                        ...
                        <a href="{{ route(getRoutePrefix() . 'machinery.repair') }}" class="btn btn-light flex-grow-1 border">Clear</a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route(getRoutePrefix() . 'machinery.repair.show', $machine->id) }}" class="btn btn-sm btn-info fw-bold">
                            ...
                            @empty
                            <tr>
                                <td colspan="8" class="text-center text-muted py-5">No machinery assets found under repair.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
