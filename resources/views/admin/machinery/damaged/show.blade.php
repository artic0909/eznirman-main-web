        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route(getRoutePrefix() . 'machinery.damaged') }}">Damaged Machinery</a></li>
...
<div class="row mt-4">
    <div class="col-12 text-center">
        <a href="{{ route(getRoutePrefix() . 'machinery.damaged') }}" class="btn btn-secondary px-5 fw-bold">
