...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <!-- Filters Section -->
                <form action="{{ route('admin.machinery.running') }}" method="GET" class="row mb-4">
                    ...
                    <div class="col-md-3 mb-2 d-flex gap-2">
                        ...
                        <a href="{{ route('admin.machinery.running') }}" class="btn btn-light flex-grow-1 border">Clear</a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('admin.machinery.running.show', $machine->id) }}" class="btn btn-sm btn-info fw-bold">
