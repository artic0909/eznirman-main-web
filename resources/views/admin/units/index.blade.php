...
<div class="row">
    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <!-- Filters Section -->
                <form action="{{ route('admin.units.index') }}" method="GET" class="row mb-4">
                    <div class="col-md-9 mb-2">
                        <input type="text" name="search" class="form-control" placeholder="Search Unit Name..." value="{{ request('search') }}">
                    </div>
                    <div class="col-md-3 mb-2 d-flex gap-2">
                        <button type="submit" class="btn btn-primary flex-grow-1">Filter</button>
                        <a href="{{ route('admin.units.index') }}" class="btn btn-light flex-grow-1 border">Clear</a>
                    </div>
                </form>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        ...
                                        <button class="btn btn-sm btn-icon btn-light-danger btn-delete" data-url="{{ route('admin.units.destroy', $unit->id) }}">
