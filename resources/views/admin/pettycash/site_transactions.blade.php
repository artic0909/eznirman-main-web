...
@section('title', 'Site Petty Cash Transactions')
        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                <div class="page-header-title">
                    <h5 class="m-b-10">{{ $site->site_name }} - Transactions</h5>
                </div>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('coordinator.dashboard') }}">Home</a></li>
                    <li class="breadcrumb-item">Petty Cash</li>
                    <li class="breadcrumb-item" aria-current="page">{{ $site->site_name }}</li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form action="{{ url('coordinator/pettycash/site/'.$site->id) }}" method="GET" id="filterForm">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-2 d-flex gap-2">
                            ...
                            <a href="{{ url('coordinator/pettycash/site/'.$site->id) }}" class="btn btn-light border px-2 d-flex align-items-center justify-content-center" title="Clear Filters">
                                <i class="ti ti-x"></i>
                            </a>
                        </div>
                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        function loadUsers(role, preselectId = null) {
            ...
            // Note: Users API route
            $.ajax({
                url: '{{ url("coordinator/pettycash/site/".$site->id."/users-by-role") }}',
                type: 'GET',
                data: { role: role },
