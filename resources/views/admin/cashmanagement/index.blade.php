...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form action="{{ route('admin.cashmanagement.index') }}" method="GET" id="filterForm">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-2 d-flex gap-2">
                            ...
                            <a href="{{ route('admin.cashmanagement.index') }}" class="btn btn-light border px-2 d-flex align-items-center justify-content-center" title="Clear Filters">
                                <i class="ti ti-x"></i>
                            </a>
                        </div>
                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        function loadUsers(role, preselectId = null) {
            ...
            $.ajax({
                url: '{{ route('admin.cashmanagement.users_by_role') }}',
                type: 'GET',
                data: { role: role },
