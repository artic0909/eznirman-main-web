...
<div class="page-header">
        ...
        <div class="row align-items-center">
            <div class="col-md-10">
                <div class="page-header-title">
                    <h5 class="m-b-10">All Supervisors</h5>
                </div>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript: void(0)">HR Management</a></li>
                    <li class="breadcrumb-item" aria-current="page">View Supervisors</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="page-header-actions col-md-2 text-end">
        <button class="btn btn-success btn-sm fw-bold" data-bs-toggle="modal"
            ...
            <i class="ti ti-plus me-2"></i><span>Add Supervisor</span>
        </button>
    </div>
</div>
<!-- [ breadcrumb ] end -->
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h5>All Supervisors</h5>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <!-- Filters Section -->
                <form action="{{ route('admin.hrmanagement.supervisors') }}" method="GET" class="row mb-4">
                    ...
                    <div class="col-md-3 mb-2 d-flex gap-2">
                        ...
                        <a href="{{ route('admin.hrmanagement.supervisors') }}" class="btn btn-light flex-grow-1 border">Clear</a>
                    </div>
                </form>
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header bg-info">
                                            <h5 class="modal-title text-white">Supervisor Details - {{ $user->code }}</h5>
                                ...
                                <div class="modal-dialog modal-xl modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header bg-warning">
                                            <h5 class="modal-title text-white">Edit Supervisor</h5>
                                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body text-center pt-0">
                ...
                <p class="text-muted" id="delete-modal-msg">Deleting this supervisor will remove them permanently!</p>
            </div>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.querySelectorAll('.btn-delete').forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                deleteMsg.innerText = "Deleting this supervisor will remove them permanently!";
                deleteModal.show();
            });
        });
