...
<html lang="en">
<head>
  <title>@yield('title', 'Accountant Dashboard') - EZ NIRMAN</title>
  <meta charset="utf-8">
              ...
              <div class="dropdown-header">
                <div class="d-flex mb-1">
                  <div class="flex-shrink-0">
                    <img src="{{ asset('logo_with_bg.png') }}" alt="user-image" class="user-avtar wid-35">
                  </div>
                  <div class="flex-grow-1 ms-3">
                    <h6 class="mb-1">{{ Auth::guard('account')->user()->name ?? 'Accountant' }}</h6>
