...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/user/send-money', [DashboardController::class, 'sendMoney'])->name('user.sendmoney');
    Route::get('/user/add-money', [DashboardController::class, 'addMoney'])->name('user.addmoney');
